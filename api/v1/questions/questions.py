...
class Questions:
    ...
    def read_category(self, id: int) -> QuestionGeneralDetail:
        """Read a quiz general detail with the given id."""
        return QuestionCategory.get(id).to_json()
    ...
    def create_quiz_general_detail(self, title: str, category_id: int,
                                   description: str, user_id: int) -> QuestionGeneralDetail:
        ...
        general_detail = QuestionGeneralDetail(
            title=title, category_id=category_id, description=description, user_id=user_id)
        general_detail.save()
        return general_detail

    def read_quiz_general_detail(self, id: int) -> QuestionGeneralDetail:
        """Read a quiz general detail with the given id."""
        return QuestionGeneralDetail.get(id).to_json()

    def update_quiz_general_detail(self, id: int, title: str = None, category_id: int = None,
    ...
    def delete_quiz_general_detail(self, id: int) -> None:
        """Delete a quiz general detail with the given id."""
        general_detail = QuestionGeneralDetail.get(id)
        general_detail.remove()

    def create_quiz(self, question: str, answer_type: str, general_detail_id: int, user_id: int) -> Question:
    ...
    def update_quiz(self, id: int, question: str = None, answer_type: str = None,
                    general_detail_id: int = None,
                    user_id: int = None) -> None:
    ...
    def create_choice(self, choice: str, question_id: int) -> Choice:
    ...
    def read_choice(self, id: int) -> Choice:
        """Read a choice with the given id."""
        return Choice.get(id)

    def update_choice(self, id: int, choice: str = None, question_id: int = None) -> None:
    ...
    def delete_choice(self, id: int) -> None:
