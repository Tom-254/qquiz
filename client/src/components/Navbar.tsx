...
const Navbar = () => {
  ...
  return (
    <nav className="sticky top-0 h-10 left-0 right-0 mt-[5px] py-[30px]  flex items-center justify-between z-20">
      <Link to="/" className="ml-[20px] lg:ml-[80px]">
        <Logo className="hidden lg:block" />
        <LogoIconSmall className="lg:hidden" />
      </Link>
      <div className={`absolute lg:static top-[62px] left-0 right-0 ${
